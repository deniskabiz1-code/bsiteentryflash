...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 pb-6 pt-2 bg-gradient-to-t from-app-canvas via-app-canvas to-transparent">
      <div className="page-inner">
        <div className="bg-app-surface rounded-full shadow-float px-2 py-2 flex items-center justify-around">
